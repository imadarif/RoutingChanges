...
angular.module('dndLists', [])
  ...
  .directive('dndDraggable', ['$parse', '$timeout', 'dndDropEffectWorkaround', 'dndDragTypeWorkaround',
    ...
    return function(scope, element, attr) {
      ...
      element.on('dragend', function(event) {
        ...
        //use to get the card value dnd-drag-value attribute

         var dndValue = scope.$eval(attr.dndDragValue);
        var dndSelectedList = scope.$eval(attr.dndSelectedList);

        var dndProjectId = scope.$eval(attr.dndProjectId);



        // console.log(dndValue);
        dndDropEffectWorkaround.setCardData(dndValue,dndSelectedList,dndProjectId)
    ...
    return function(scope, element, attr) {
      ...
      element.on('drop', function(event) {
       ...
       // console.log(targetArray);
        var transferredObjectData = dndDropEffectWorkaround.getCardData();

        scope.$apply(function(){

        console.log(transferredObject)
      //    console.log(transferredObjectData)


        });

        $timeout((function(){
          removeObject(transferredObjectData)
          addObjectToNewList(targetArray,transferredObjectData)
        }),1)



     //   console.log(transferredObject) //transfered object
      //  console.log(getPlaceholderIndex()) //index of applying @ index
        //scope.$apply(function() {
        //
        ...
        function removeObject(transferredObjectData){
          var projectRef = groupTasksRef + '/' + 'panacloud' + '/' + 'panaswift' + '/' + transferredObjectData.dragProjectId + '/' +'lists'+'/' +transferredObjectData.draglistName + '/' + 'task' + '/' + transferredObjectData.dragobjectId;
        ...
        function addObjectToNewList(targetArray,transferredObjectData){
          var projectRef = groupTasksRef + '/' + 'panacloud' + '/' + 'panaswift' + '/' + transferredObjectData.dragProjectId + '/' +'lists'+'/' + targetArray + '/' + 'task';
          ref = new Firebase(projectRef);
          ref.push({
            task : transferredObject.task,
            attachment : transferredObject.attachment,
          })
        }
      ...
      function getPlaceholderIndex() {
        console.log(Array.prototype.indexOf.call(listNode.children, placeholderNode))
  ...
  .factory('dndDropEffectWorkaround', function(){
      ...
      return {
      setCardData : function(id,listName,projectId){
        console.log(id,listName,projectId)
        dragObject.dragobjectId = id;
        dragObject.draglistName = listName;
        dragObject.dragProjectId = projectId;
        },
